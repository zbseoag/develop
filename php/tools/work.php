...
<li><textarea name="data"  id="data"style="width: 100%;padding: 4px;font:16px 'Courier New'; box-sizing: border-box;" rows="30"></textarea></li>
...
<button class="button" value="execC" type="button">C 语言</button>
<button class="button" value="execPhp" type="button">PHP 语言</button>
<button class="button" value="execPython" type="button">Python 语言</button>
