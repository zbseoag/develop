...
public class UserController {
	...
	private Map<String, User> userDatabase = new HashMap<>() {
		{
			var user1 = new User("bob@example.com", "bob123", "Bob", "This is bob.");
			var user2 = new User("tom@example.com", "tomcat", "Tom", "This is tom.");
